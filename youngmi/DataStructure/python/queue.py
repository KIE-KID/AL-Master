...
# 맨처음 요소를 제거해야하기 때문에 인덱스가 0인 요소 pop
...
# deque 라이브러리는 stack과 queue 장점을 모두 합친 자료구조
...
# 첫번째 요소 제거
print("큐에서 제거한 요소:",deque_queue.popleft()) # 가장 왼쪽 요소 제거, 큐에서 제거한 요소: item1 - O(1)
print(deque_queue) # deque(['item2', 'item3'])

deque_queue.reverse() # #역순으로 바꾸기
print(deque_queue)